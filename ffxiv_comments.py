...
def main() -> None:
    ...
    addonSigs = {
        "E8 ?? ?? ?? ?? 48 89 45 17", # AgentInterface_GetAddonTextById
        "E8 ?? ?? ?? ?? 48 8D 4F 40 48 8B D0", # RaptureTextModule_FormatAddonTextApply

        "E8 ?? ?? ?? ?? 8D 4F 0A",                                                                   # RaptureTextModule_GetAddonText
        "E8 ?? ?? ?? ?? EB 3A 33 FF",                                                                # RaptureTextModule_FormatAddonText1<string>
        "E8 ?? ?? ?? ?? 41 8D 4E 4E",                                                                # RaptureTextModule_FormatAddonText1<string,int>
        "E8 ?? ?? ?? ?? EB 67 B8",                                                                   # RaptureTextModule_FormatAddonText1<string,int,uint>
        "E8 ?? ?? ?? ?? 44 8B 4F 20 48 8B D0 41 B0 03",                                              # RaptureTextModule_FormatAddonText1<string,string>
        "E8 ?? ?? ?? ?? 48 8B D0 48 8B CE E8 ?? ?? ?? ?? 48 8B 8E",                                  # RaptureTextModule_FormatAddonText1<string,string,string>
        "E8 ?? ?? ?? ?? 8B 5D 58",                                                                   # RaptureTextModule_FormatAddonText1<int>
        "E8 ?? ?? ?? ?? 41 83 FF 64",                                                                # RaptureTextModule_FormatAddonText1<int,int>
        "E8 ?? ?? ?? ?? 44 8B 7D D7",                                                                # RaptureTextModule_FormatAddonText1<int,int,uint>
        "E8 ?? ?? ?? ?? EB 1C FF 50 30",                                                             # RaptureTextModule_FormatAddonText1<int,int,uint,uint>
        "E8 ?? ?? ?? ?? 8B CD 49 83 C9 FF",                                                          # RaptureTextModule_FormatAddonText1<int,string>
        "E8 ?? ?? ?? ?? EB 09 49 8D 4D 20",                                                          # RaptureTextModule_FormatAddonText2<string>
        "E8 ?? ?? ?? ?? 33 C9 48 8B F8",                                                             # RaptureTextModule_FormatAddonText2<string,int>
        "E8 ?? ?? ?? ?? 48 8B D0 48 8D 4D 80 E8 ?? ?? ?? ?? 41 8D 55 06",                            # RaptureTextModule_FormatAddonText2<string,int,uint>
                                                                                                     # RaptureTextModule_FormatAddonText2<string,int,uint,uint> # unused
        "E8 ?? ?? ?? ?? 48 8B D0 48 8D 4D D0 E8 ?? ?? ?? ?? 49 8B 9F",                               # RaptureTextModule_FormatAddonText2<string,int,uint,uint,uint>
                                                                                                     # RaptureTextModule_FormatAddonText2<string,int,uint,uint,uint,uint> # unused
        "E8 ?? ?? ?? ?? 48 8B 8C 24 ?? ?? ?? ?? 45 33 C9",                                           # RaptureTextModule_FormatAddonText2<string,int,uint,uint,uint,uint,uint>
        "E8 ?? ?? ?? ?? 41 8D 57 01 48 C1 E2 04",                                                    # RaptureTextModule_FormatAddonText2<string,string>
                                                                                                     # RaptureTextModule_FormatAddonText2<string,string,string> # unused
        "E8 ?? ?? ?? ?? 44 8B 74 24 ?? 48 8B D0 48 8D 85",                                           # RaptureTextModule_FormatAddonText2<string,string,uint>
                                                                                                     # RaptureTextModule_FormatAddonText2<string,string,uint,uint> # unused
        "E8 ?? ?? ?? ?? 45 33 F6 48 8B F8 41 8B CE 41 39 4F 08",                                     # RaptureTextModule_FormatAddonText2<string,string,uint,uint,uint>
        "E8 ?? ?? ?? ?? 4C 8B C0 C6 44 24 ?? ?? 45 33 C9 33 D2 49 8B CC E8 ?? ?? ?? ?? 4C 8B 7C 24", # RaptureTextModule_FormatAddonText2<string,string,string,uint,uint>
        "E8 ?? ?? ?? ?? 41 B0 07",                                                                   # RaptureTextModule_FormatAddonText2<int>
        "E8 ?? ?? ?? ?? 4C 8B C0 EB 0F",                                                             # RaptureTextModule_FormatAddonText2<int,int>
        "E8 ?? ?? ?? ?? 48 8B D0 8D 43 04",                                                          # RaptureTextModule_FormatAddonText2<int,int,uint>
        "E8 ?? ?? ?? ?? EB 18 33 C0",                                                                # RaptureTextModule_FormatAddonText2<int,int,uint,uint>
        "E8 ?? ?? ?? ?? 8D 4E 64",                                                                   # RaptureTextModule_FormatAddonText2<int,int,uint,uint,uint>
                                                                                                     # RaptureTextModule_FormatAddonText2<int,int,uint,uint,uint,uint> # unused
        "E8 ?? ?? ?? ?? 48 8B 4C 24 ?? 45 33 C9 4C 8B C0 44 88 7C 24",                               # RaptureTextModule_FormatAddonText2<int,int,uint,uint,uint,uint,uint>
        "E8 ?? ?? ?? ?? EB 41 41 8B DF",                                                             # RaptureTextModule_FormatAddonText2<int,string>
        "E8 ?? ?? ?? ?? 4C 8B C0 C6 44 24 ?? ?? 41 8D 55 6E",                                        # RaptureTextModule_FormatAddonText2<int,int,string>
                                                                                                     # RaptureTextModule_FormatAddonText2<int,string,uint> # unused

        "E8 ?? ?? ?? ?? 41 8D 4D 07",
        "48 83 EC 38 4C 8D 81",
        "48 83 EC 28 48 8B 05 ?? ?? ?? ?? 44 8B C1 33 D2", # ecx
        "E8 ?? ?? ?? ?? 49 8D 5F 02", # ecx
    }
    ...
    scan_and_comment("GetLobbyText2", "E8 ?? ?? ?? ?? FF C5 48 85 C0", lobbyRows)
    scan_and_comment("RaptureLogModule_ShowLogMessage", "E8 ?? ?? ?? ?? 44 03 FB", logmessageRows)
    scan_and_comment("RaptureLogModule_ShowLogMessage<uint>", "E9 ?? ?? ?? ?? 48 8B 49 08 48 8B 01 FF 50 58", logmessageRows)
    scan_and_comment("RaptureLogModule_ShowLogMessage<uint,uint>", "E8 ?? ?? ?? ?? 0F B7 46 32", logmessageRows)
    scan_and_comment("RaptureLogModule_ShowLogMessage<string>", "E8 ?? ?? ?? ?? EB 68 48 8B 07", logmessageRows)
    scan_and_comment("BattleLog_AddLogMessage", "E8 ?? ?? ?? ?? 40 88 73 14", logmessageRows)
    scan_and_comment("SomeLogMessage", "E8 ?? ?? ?? ?? C6 43 34 03", logmessageRows)
    scan_and_comment("BattleLog_AddActionLogMessage", "E8 ?? ?? ?? ?? 8D 46 FB", logmessageRows)
    scan_and_comment("ConfigBase_GetConfigOption", "E8 ?? ?? ?? ?? 39 70 18", configOptions)
    scan_and_comment("ExdModule_GetSheetByIndex", "E8 ?? ?? ?? ?? FE 47 30", exl)
    scan_and_comment("ExdModule_GetRowCountBySheetIndex", "E8 ?? ?? ?? ?? 3B D8 73 35", exl, True)
    scan_and_comment("ExdModule_GetRowBySheetIndexAndRowIndex", "E8 ?? ?? ?? ?? 0F 57 F6 48 85 C0", exl, True)
    scan_and_comment("ExdModule_GetRowBySheetIndexAndRowId", "E8 ?? ?? ?? ?? EB 11 33 C0", exl, True)
    scan_and_comment("ExdModule_GetRowBySheetIndexAndRowIdAndSubRowId", "E8 ?? ?? ?? ?? 48 85 C0 74 46 48 8B 18", exl, True)
    scan_and_comment("QuestManager_IsQuestAccepted", "45 33 C0 48 8D 41 18 66 39 10", quests)
    scan_and_comment("QuestManager_IsQuestComplete1", "E8 ?? ?? ?? ?? 88 46 1C", quests)
    scan_and_comment("AgentHUD_IsMainCommandEnabled", "48 8B 81 ?? ?? ?? ?? 44 8B C2 83 E2 1F", maincommands)
    scan_and_comment("AgentHUD_SetMainCommandEnabledState", "E8 ?? ?? ?? ?? 41 B0 01 EB 27", maincommands)
    scan_and_comment("RaptureAtkModule_OpenAddon", "E8 ?? ?? ?? ?? 66 89 46 50", addonNames)
    scan_and_comment("InventoryManager_GetInventoryContainer", "E8 ?? ?? ?? ?? 44 0F BE C7", inventoryTypes)

    update_conditions("48 8D 0D ?? ?? ?? ?? 41 8D 50 27 E8 ?? ?? ?? ?? 33 D2 44 8D 42 01", conditions)
    update_executecommand("E8 ?? ?? ?? ?? C6 03 01 48 8B 5C 24")
